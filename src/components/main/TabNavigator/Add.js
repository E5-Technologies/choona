                ...
                <SafeAreaView style={{ flex: 1 }}>
                    ...
                    {_.isEmpty(data) ?
                        ...
                        <View style={{ flex: 1, justifyContent: "center", alignItems: "center", }}>
                            ...
                            <Text style={{
                                color: Colors.white, fontSize: normalise(12), fontWeight: 'bold',
                                marginTop: normalise(20), width: '60%', textAlign: 'center',
                            }}>Search for the song you want to </Text>
                             <Text style={{
                                color: Colors.white, fontSize: normalise(12), fontWeight: 'bold',
                              width: '60%',
                            }}>share above.</Text>
                            <Image source={ImagePath.addPostIllus} resizeMode='contain'
                             style={{ height:undefined,width:'100%',aspectRatio:1125/712,position:'absolute',bottom:-80 }} />
